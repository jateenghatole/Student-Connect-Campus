...
class _Tutorial3WidgetState extends State<Tutorial3Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Tutorial3Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'tutorial_3'});
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('TUTORIAL_3_arrow_back_rounded_ICN_ON_TAP');
