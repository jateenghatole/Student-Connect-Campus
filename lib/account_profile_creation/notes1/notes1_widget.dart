...
class _Notes1WidgetState extends State<Notes1Widget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'NOTES1'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('NOTES1_arrow_back_rounded_ICN_ON_TAP');
              ...
              children: [
                Padding(
                  ...
                  child: FlutterFlowPdfViewer(
                    assetPath: 'assets/pdfs/unit-1_new.pdf',
                    height: 300.0,
                ...
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(10.0, 10.0, 10.0, 10.0),
                  child: FlutterFlowPdfViewer(
                    assetPath: 'assets/pdfs/unit-2_new.pdf',
                    height: 300.0,
                    horizontalScroll: false,
                  ),
                ),
