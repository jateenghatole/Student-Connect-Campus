...
class _CreateTaskWidgetState extends State<CreateTaskWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'create_task'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('CREATE_TASK_create_task_ON_INIT_STATE');
      if (/* NOT RECOMMENDED */ _model.taskTextController.text == 'true') {
        logFirebaseEvent('create_task_update_app_state');
        setState(() {
          FFAppState().addToTODOLIST(_model.taskTextController.text);
        });
      }
    });
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'CREATE_TASK_PAGE_CREATE_TASK_BTN_ON_TAP');
                        logFirebaseEvent('Button_backend_call');

                        await TaskRecord.collection
                            .doc()
                            .set(createTaskRecordData(
                              taskTitle: _model.taskTextController.text,
                              taskDescripition:
